		            ...
		            <form method="POST" action="{{ route('admin.product.update', $product->id) }}" enctype="multipart/form-data">
		                ...
		                <div class="row">
		                		...
		                		<div class="card-body">
									<div class="row mb-3">
										<div class="form-group col-md-6">
											...
											<input type="text" value="{{ $product->p_name_en }}" class="form-control" id="p_name_en" name="p_name_en">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" value="{{ $product->p_name_bn }}" class="form-control" id="p_name_bn" name="p_name_bn">
									...
									<div class="row mb-3">
										<div class="form-group col-md-6">
											...
											<input type="text" value="{{ $product->p_code }}" class="form-control" id="p_code" name="p_code">
										...
										<div class="form-group col-md-6">
											...
											<select class="form-control" id="subcat_id" name="subcat_id">
												...
												<option disabled class="text-danger">{{ $category->cat_name_en }}|{{ $category->cat_name_bn }}</option>
													...
													<option {{ $product->subcat_id == $subcat->id?'selected':'' }} value="{{ $subcat->id }}">-- {{ $subcat->subcat_name_en }}|{{ $subcat->subcat_name_bn }}</option>
													@endforeach
												@endforeach
											</select>
									...
									<div class="row mb-3">
										<div class="form-group col-md-6">
											...
											<select class="form-control" id="caste_id" name="caste_id">
												...
												<option {{ $product->caste_id == $caste->id?'selected':'' }} value="{{ $caste->id }}">{{ $caste->caste_name_en }}|{{ $caste->caste_name_bn }}</option>
												@endforeach
											</select>
										...
										<div class="form-group col-md-6">
											...
											<select class="form-control" id="garden_id" name="garden_id">
												...
												<option {{ $product->garden_id == $garden->id?'selected':'' }} value="{{ $garden->id }}">{{ $garden->garden_name_en }}|{{ $garden->garden_name_bn }}</option>
												@endforeach
											</select>
									...
									<div class="row mb-3">
										...
										<div class="form-group col-md-6">
											...
											<input type="number" value="{{ $product->stock_qty }}" class="form-control" id="stock_qty" name="stock_qty">
									...
									<div class="form-group mb-3">
										...
										<textarea name="p_description_en" id="p_description_en" class="form-control des_en">{{ $product->p_description_en }}</textarea>
									...
									<div class="form-group mb-3">
										...
										<textarea name="p_description_bn" id="p_description_bn" class="form-control des_bn">{{ $product->p_description_bn }}</textarea>
									...
									<div class="form-group mb-3">
										...
										<input type="text" name="yt_video_code" id="yt_video_code" class="form-control" placeholder="YouTube video embeded code ..." value="{{ $product->yt_video_code }}" />
									</div>
								</div>
		                	...
		                	<div class="col-md-4">
		                		...
		                		<div class="form-group mb-3">
									<label for="thumbnail" class="text-dark form-label">Existing Thumbnail</label><br>
									<img src="{{ asset('storage/'.$product->thumbnail) }}" height="120" width="auto" alt="">
								</div>
								@endisset
				                	...
				                	<div class="col-md-4">
					                	<div class="card form-group p-2">
						                	...
						                	<div class="form-check form-switch">
											  <input class="form-check-input" {{ $product->slider==1?'checked':'' }} value="1" type="checkbox" role="switch" name="slider" id="slider">
											</div>
										</div>
									</div>
				                	<div class="col-md-4">
					                	<div class="card form-group p-2">
						                	...
						                	<div class="form-check form-switch">
											  <input class="form-check-input" {{ $product->hot_deal==1?'checked':'' }} value="1" type="checkbox" role="switch" name="hot_deal" id="hot_deal">
											</div>
										</div>
									</div>
				                	<div class="col-md-4">
					                	<div class="card form-group p-2">
						                	...
						                	<div class="form-check form-switch">
											  <input class="form-check-input" value="1" {{ $product->today_deal==1?'checked':'' }} type="checkbox" role="switch" name="today_deal" id="today_deal">
											</div>
										</div>
									</div>
				                </div>
				                ...
				                <div class="row">
				                	<div class="col-md-4">
					                	<div class="card form-group p-2">
						                	...
						                	<div class="form-check form-switch">
											  <input class="form-check-input" value="1" {{ $product->trendy==1?'checked':'' }} type="checkbox" role="switch" name="trendy" id="trendy">
											</div>
										</div>
									</div>
				                	<div class="col-md-4">
					                	<div class="card form-group p-2">
						                	...
						                	<div class="form-check form-switch">
											  <input class="form-check-input" value="1" {{ $product->featured==1?'checked':'' }} type="checkbox" role="switch" name="featured" id="featured">
											</div>
										</div>
									</div>
				                	<div class="col-md-4">
					                	<div class="card form-group p-2">
						                	...
						                	<div class="form-check form-switch">
											  <input class="form-check-input" value="1" {{ $product->status==1?'checked':'' }} type="checkbox" role="switch" name="status" id="status">
											</div>
										</div>
									</div>
				                </div>
...
<script>
	...
	$(document).ready(function(){      
       ...
       //edit product image remove by cros btn
