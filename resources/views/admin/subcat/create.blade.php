	   ...
	   <div class="row justify-content-center mt-5">
	        <div class="col-xl-6 col-md-6">
	            ...
	            <div class="card text-white mb-4">
		            <form method="POST" action="{{ route('admin.subcat.store') }}">
		                @csrf
		                ...
		                <div class="card-body">
							<div class="form-group mb-3">
								...
								<select name="cat_id" id="cat_id" class="form-control">
									...
									<option class="text-primary" value="{{ $category->id }}">{{ $category->cat_name_en }}||{{ $category->cat_name_bn }}</option>
									@endforeach
								</select>
							...
							<input type="text" value="{{ old('subcat_name_en') }}" class="form-control" id="subcat_name_en" name="subcat_name_en">
							...
							<input type="text" value="{{ old('subcat_name_bn') }}" class="form-control" id="subcat_name_bn" name="subcat_name_bn">
